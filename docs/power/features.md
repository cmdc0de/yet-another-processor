...
|----|---------|--------|-----------|
| POWER-001 | Sources under `hw/power/` | open | |
| POWER-002 | Simulation builds and runs on Linux (dev host) | open | |
| POWER-003 | Tests fail if the chosen simulator is missing | open | |

## Rails

| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| POWER-004 | Named 5 V system input and 0 V VSS | open | |
| POWER-005 | Regulator from that 5 V input to a named 3.3 V VDD | open | |
| POWER-006 | With 5 V in, simulated VDD is 3.3 V within the named tolerance (`design.md`) | open | |

## Domain

| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| POWER-007 | CPU core, SRAM/bus, and MCU I/O use the 3.3 V rail (not the 5 V input) | open | |
