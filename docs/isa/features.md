...
| ISA-012 | ~~Shift right logical~~ | done | m2 |
| ISA-013 | ~~Shift right arithmetic~~ | done | m2 |
...
| ISA-017 | ~~Integer divide instruction~~ | done | m3 |

## Memory

| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| ISA-018 | ~~Load word~~ | done | m3 |
| ISA-019 | ~~Store word~~ | done | m3 |
| ISA-020 | ~~Load byte~~ | done | m3 |
| ISA-021 | ~~Store byte~~ | done | m3 |
| ISA-022 | ~~Load halfword~~ | done | m3 |
| ISA-023 | ~~Store halfword~~ | done | m3 |
| ISA-024 | ~~Defined endianness for multi-byte memory (LE vs BE is `design.md`)~~ | done | m3 |

## Immediates and addressing

| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| ISA-025 | ~~Form a 32-bit constant in a small, fixed number of instructions~~ | done | m2 |
| ISA-026 | ~~PC-relative address formation~~ | done | m2 |
...
| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| ISA-033 | ~~User and supervisor privilege levels~~ | done | m5 |
| ISA-034 | ~~Supervisor-only instructions (status, protection, privilege)~~ | done | m5 |
| ISA-035 | ~~Trap/exception entry saves enough state to return~~ | done | m5 |
| ISA-036 | ~~Return-from-trap~~ | done | m5 |
| ISA-037 | ~~Simple memory protection (base/limit or MPU; pick in `design.md`)~~ | done | m5 |
| ISA-038 | ~~Protection-violation trap~~ | done | m5 |
| ISA-039 | ~~Supervisor interrupt enable/disable~~ | done | m5 |
| ISA-040 | ~~External interrupt trap~~ | done | m5 |

## Reserved VM (ISA contract only; no v1 MMU)

| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| ISA-041 | ~~Reserved cause codes for translation miss and page fault~~ | done | m5 |
| ISA-042 | ~~Reserved translation-enable control (ignored or trapped on v1)~~ | done | m5 |

## Coprocessor / FPU hook

| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| ISA-043 | ~~Coprocessor opcode space distinct from integer ISA~~ | implemented | m6 |
| ISA-044 | ~~Move to/from coprocessor registers~~ | implemented | m6 |
| ISA-045 | ~~Unimplemented coprocessor op traps (software float until FPU exists)~~ | implemented | m6 |

## ABI

| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| ISA-046 | ~~Designated stack-pointer GPR (not `r0`–`r2`)~~ | implemented | m6 |
| ISA-047 | ~~Stack discipline (growth direction and alignment)~~ | implemented | m6 |
| ISA-048 | ~~Argument, return-value, callee-saved, and caller-saved assignment (writable GPRs only)~~ | implemented | m6 |
