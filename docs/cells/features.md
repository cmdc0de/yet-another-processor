...
|----|---------|--------|-----------|
| CELL-001 | Cell tests use 3.3 V VDD and 0 V VSS | open | |
| CELL-002 | N-channel and P-channel MOSFET models in the library (SOT-23 parts named in design.md) | open | |
...
| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| CELL-004 | CMOS inverter: logic 0 in → 1 out; 1 in → 0 out | open | |
| CELL-005 | 2-input NAND | open | |
...
| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| CELL-014 | Combinational outputs sit within named VOH/VOL of the rails (values in design.md) | open | |
...
| CELL-018 | Tests run from the repo (script or documented batch) without a GUI | open | |
