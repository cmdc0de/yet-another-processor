...
| CELL-006 | 2-input NOR | claimed | m2 |
| CELL-007 | 2-input AND | claimed | m2 |
| CELL-008 | 2-input OR | claimed | m2 |
| CELL-009 | 2-input XOR | claimed | m2 |
| CELL-010 | Transmission gate (or analog mux used as one) | claimed | m2 |
| CELL-011 | 2:1 logic mux | claimed | m2 |
