...
| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| GPU-007 | ~~CPU-visible port so software can write the backbuffer~~ | implemented | m2 |
| GPU-008 | ~~Fill or blit a rectangle of pixels into the backbuffer~~ | implemented | m2 |
