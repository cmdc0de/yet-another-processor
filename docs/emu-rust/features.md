...
| EMU-RUST-013 | ~~32 GPRs; `r0=0`, `r1=1`, `r2=0xFFFFFFFF`; writes to `r0`–`r2` discarded; ops targeting `r0` still update flags~~ | implemented | m2 |
| EMU-RUST-014 | ~~FLAGS Z, N, C, V per `docs/isa/design.md`~~ | implemented | m2 |

## Integer execute

| ID | Feature | Status | Milestone |
|----|---------|--------|-----------|
| EMU-RUST-015 | ~~SPECIAL ALU: ADD, SUB, AND, OR, XOR, NOT, SLL, CMP, TEST, TEQ, NOP; flags as ISA~~ | implemented | m2 |
