...
| PHYSICAL-CPU-005 | ~~1-bit FLAGS latch schematic (Z/N/C/V bit; WE from control)~~ | implemented | m2 |
| PHYSICAL-CPU-006 | ~~1-bit full adder schematic: `a`, `b`, `cin`, `sum`, `cout`~~ | implemented | m2 |
| PHYSICAL-CPU-007 | ~~Adder netlist matches CELL-012 truth table at VOL/VOH~~ | implemented | m2 |
